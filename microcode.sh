...
intel() {
  ...
  intel_microcode=$(curl -fsSL "https://mirrors.cernet.edu.cn/debian/pool/non-free-firmware/i/intel-microcode//" | grep -o 'href="[^"]*amd64.deb"' | sed 's/href="//;s/"//')
...
amd() {
  amd_microcode=$(curl -fsSL "https://mirrors.cernet.edu.cn/debian/pool/non-free-firmware/a/amd64-microcode///" | grep -o 'href="[^"]*amd64.deb"' | sed 's/href="//;s/"//')
  ...
  wget -q https://mirrors.cernet.edu.cn/debian/pool/non-free-firmware/a/amd64-microcode/$microcode
